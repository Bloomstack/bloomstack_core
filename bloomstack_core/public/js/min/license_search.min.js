(function () {
    ...
    var script$3 = {
        ...
        methods: {
            makeCustomer: function makeCustomer() {
                var customer = {
                    "doctype": "Customer",
            ...
            makeSupplier: function makeSupplier() {
                var supplier = {
                    "doctype": "Customer",
                    "customer_name": this.license.business_owner || this.license.legal_name,
                    "customer_group": "Individual",
    ...
    __vue_render__$4._withStripped = true;
      ...
      function __vue_normalize__$4(
        ...
        // For security concerns, we use only base name in production mode.
        component.__file = "/Users/jitendraharpalani/Jeet/workspace/bloomstack/apps/bloomstack_core/bloomstack_core/public/js/bloomstack_core/components/paginate.vue";
    ...
    var FrappeService = {
        insertDoc: function insertDoc(doc) {
