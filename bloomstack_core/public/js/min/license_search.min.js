(function () {
    ...
    var FrappeService = {
        insertDoc: function insertDoc(ref) {
            ...
            console.log({ doc: doc, isFieldExist: isFieldExist });
            return new Promise(function (resolve, reject) {
        ...
        var script$3 = {
            ...
            methods: {
                quick_entry: function quick_entry(doctype, fieldMap) {
                    var mapper = {};
                    for(var customerField in fieldMap) {
                        var licenseField = fieldMap[customerField];
    ...
    // ignored /home/neha/Frappeoffice/frappe_bloomstack_core/apps/bloomstack_core/node_modules/nprogress/nprogress.css
